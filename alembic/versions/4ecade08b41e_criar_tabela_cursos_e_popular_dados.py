...
def upgrade() -> None:
    ...
    op.bulk_insert(
        cursos_table,
        [
            {"id": uuid.uuid4(), "nome": "ciência da computação", "ativo": True},
            {"id": uuid.uuid4(), "nome": "engenharia de software", "ativo": True},
            {"id": uuid.uuid4(), "nome": "engenharia de produção", "ativo": True},
            {"id": uuid.uuid4(), "nome": "engenharia mecânica", "ativo": False},
            {"id": uuid.uuid4(), "nome": "engenharia civil", "ativo": False},
        ],
    )
